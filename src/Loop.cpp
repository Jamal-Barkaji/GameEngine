...
void Loop::run(Window& window, IOpenGLRenderer& renderer, Transformer& transformer, Camera& camera, Scene& scene, OpenGLShader& mainShader, OpenGLShader& shadowShader, PhysicsSystem& physics) {
        bool quit = false;
        SDL_Event e;
